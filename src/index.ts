...
import fantasyRosterHistoryRouter from "./routers/fantasy-roster-history";
import fantasyTeamRouter from "./routers/fantasy-team";
import fantasyTeamHistoryRouter from "./routers/fantasy-team-history";
...
app.use(fantasyRosterHistoryRouter.routes());
app.use(fantasyTeamRouter.routes());
app.use(fantasyTeamHistoryRouter.routes());
